...
export const Navbar: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      {/* Mobile Menu Drawer */}
      <div
        className={`md:hidden fixed top-[72px] right-0 left-0 bg-white/95 dark:bg-charcoal-900/95 backdrop-blur-md shadow-lg border-b border-stone-100 dark:border-charcoal-800 transition-all duration-300 ease-in-out ${isOpen ? 'opacity-100 translate-y-0 visible' : 'opacity-0 -translate-y-4 invisible pointer-events-none'
          }`}
      >
